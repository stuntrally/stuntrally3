...
Help and contributing is welcome, general info [here](https://github.com/stuntrally/stuntrally3/blob/master/Contributing.md).
...
How to build (compile) project from sources is described [here](https://github.com/stuntrally/stuntrally3/blob/master/Building.md).
