...
const static SETTINGS::Veget veget[8] = {  /* 🌳🪨🪴🌿 Veget only
	...
	{1.5f,1.5f,1.5f,1.7f,1.5f,1.7f, 0.6f,0.0f,0.5f,0.1f, 25000 },  // Very high
...
Qlty   | Tex        |        | LOD,hor   | Cnt Dist |  | Reflect         | Skip             | 🔆 lens
	\  \ fil Visibl |  Road  | Horiz |   | | Typ |  |  | | refra         | | Faces     IBL  | | 🌄 beams
	...
	{2, 4,2, 40000, 1.2,2.5, 1,0,1,2,2,  3,3,1, 500,2, 1,1,1, 1000,0.4,  1,2,1,  700,0.4,0, 0,0,0,0 },  // High
	{2, 4,3, 60000, 1.5,3.0, 1,0,2,2,2,  3,3,1, 700,3, 1,1,1, 3000,0.4,  2,0,1, 1000,0.4,0, 0,0,0,0 },  // Higher *
	{2, 8,3, 60000, 1.8,3.5, 2,1,3,3,3,  3,3,1,1000,3, 2,1,1, 6000,0.6,  2,0,2, 2000,0.6,2, 1,0,0,0 },  // Very high
	{2, 16,3,60000, 2.4,4.0, 2,2,3,3,3,  4,3,1,1300,4, 3,1,1,20000,0.8,  3,0,3,20000,0.8,2, 1,0,0,0 },  // Highest
	{3, 16,3,60000, 2.4,4.0, 2,2,3,4,4,  4,3,1,2000,4, 4,1,1,60000,1.0,  3,0,4,60000,1.0,4, 1,0,0,0 },  // Ultra
};
