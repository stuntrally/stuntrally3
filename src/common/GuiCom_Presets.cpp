...
{4,2, 40000, 1.2,2.5, 1,0,1,2,2, 1.0f,1.0f,1.0f,1.0f, 3,3,1, 500,3, 0,0, 1,1,1, 1000,0.4,  1,2,1,  700,0.4,0 },  // High
{4,3, 60000, 1.5,3.0, 1,0,2,2,2, 1.5f,1.0f,1.2f,1.4f, 3,3,1, 700,4, 0,0, 1,1,1, 3000,0.4,  2,0,1, 1000,0.4,0 },  // Higher *

{8,3, 60000, 1.8,3.5, 2,1,3,3,3, 1.5f,1.5f,1.5f,1.7f, 3,3,1,1000,4, 0,0, 2,1,1, 6000,0.6,  2,0,2, 2000,0.6,2 },  // Very high
{16,3,60000, 2.4,4.0, 2,2,3,3,3, 2.0f,2.0f,2.0f,2.0f, 4,4,1,1300,5, 0,0, 3,1,1,20000,0.8,  3,0,3,20000,0.8,2 },  // Highest
{16,3,60000, 2.4,4.0, 2,2,3,4,4, 2.5f,2.5f,3.0f,3.0f, 4,4,1,2000,5, 0,0, 4,1,1,60000,1.0,  3,0,4,60000,1.0,4 },  // Ultra
	};
