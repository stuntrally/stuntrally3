...
void CGuiCom::comboGraphicsAll(ComboBoxPtr cmb, size_t val)
{
	...
	{
	case 0:  // Lowest  -------------
		s.anisotropy = 0;  s.view_distance = 1000;  s.terdetail = 2.0f;  s.road_dist = 1.0;
		// s.tex_size = 0;  s.ter_mtr = 0;  s.ter_tripl = 0;
	...
	case 1:  // Low  -------------
		s.anisotropy = 0;  s.view_distance = 1500;  s.terdetail = 1.7f;  s.road_dist = 1.2;
		// s.tex_size = 0;  s.ter_mtr = 1;  s.ter_tripl = 0;
		// s.water_reflect = 0;  s.water_refract = 0;  s.water_rttsize = 0;
		s.shadow_type = Sh_None;  s.shadow_size = 0;  s.shadow_count = 1;  s.shadow_dist = 100;
		s.gui.trees = 0.f;  s.grass = 0.f;  s.trees_dist = 1.f;  s.grass_dist = 1.f;	break;

	case 2:  // Medium  -------------
		s.anisotropy = 2;  s.view_distance = 2500;  s.terdetail = 1.5f;  s.road_dist = 1.4;
		// s.tex_size = 1;  s.ter_mtr = 1;  s.ter_tripl = 0;
		// s.water_reflect = 0;  s.water_refract = 0;  s.water_rttsize = 0;
	...
	case 3:  // High  -------------
		s.anisotropy = 4;  s.view_distance = 6000;  s.terdetail = 1.2f;  s.road_dist = 1.6;
		// s.tex_size = 1;  s.ter_mtr = 2;  s.ter_tripl = 0;
	...
	case 4:  // Higher (default)  -------------
		s.anisotropy = 4;  s.view_distance = 8000;  s.terdetail = 1.0f;  s.road_dist = 1.6;
		// s.tex_size = 1;  s.ter_mtr = 2;  s.ter_tripl = 1;
	...
	case 5:  // Very High  -------------
		s.anisotropy = 4;  s.view_distance = 12000;  s.terdetail = 1.0f;  s.road_dist = 2.0;
		// s.tex_size = 1;  s.ter_mtr = 2;  s.ter_tripl = 1;
	...
	case 6:  // Highest  -------------
		s.anisotropy = 8;  s.view_distance = 16000;  s.terdetail = 0.9f;  s.road_dist = 2.4;
	...
	case 7:  // Ultra max  -------------
		s.anisotropy = 8;  s.view_distance = 20000;  s.terdetail = 0.8f;  s.road_dist = 3.0;
		// s.tex_size = 1;  s.ter_mtr = 2;  s.ter_tripl = 2;
