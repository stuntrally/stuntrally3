...
void CGuiCom::comboGraphicsAll(ComboBoxPtr cmb, size_t val)
{
	...
	case 0:  // Lowest  -------------
		...
		s.ter_tripl = 0;  s.horizons = 0;  // s.ter_mtr = 0;
	...
	case 1:  // Low  -------------
		...
		s.ter_tripl = 0;  s.horizons = 0;  // s.ter_mtr = 1;
		// s.water_reflect = 0;  s.water_refract = 0;  s.water_rttsize = 0;
		s.shadow_type = Sh_None;  s.shadow_size = 0;  s.shadow_count = 1;  s.shadow_dist = 100;
		s.gui.trees = 0.f;  s.grass = 0.f;  s.trees_dist = 1.f;  s.grass_dist = 1.f;	break;
	...
	case 2:  // Medium  -------------
		...
		s.ter_tripl = 0;  s.horizons = 1;  // s.ter_mtr = 1;
		// s.water_reflect = 0;  s.water_refract = 0;  s.water_rttsize = 0;
	...
	case 3:  // High  -------------
		...
		s.ter_tripl = 0;  s.horizons = 1;  // s.ter_mtr = 2;
	...
	case 4:  // Higher (default)  -------------
		...
		s.ter_tripl = 1;  s.horizons = 2;  // s.ter_mtr = 2;
	...
	case 6:  // Highest  -------------
		s.anisotropy = 8;  s.view_distance = 40000;
		s.lod_bias = 1.5f;  s.ter_detail = 2.f;  s.road_dist = 2.4;
		s.ter_tripl = 2;  s.horizons = 3;  // s.ter_mtr = 2;
		// s.water_reflect = 1;  s.water_refract = 1;  s.water_rttsize = 1;
	...
	case 7:  // Ultra max  -------------
		s.anisotropy = 16;  s.view_distance = 40000;
