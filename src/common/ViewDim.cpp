...
void ViewDim::SetDim(int views, bool horizontal, int i/*player view*/)
{
	...
	case 2:
		if (horizontal)                             // [     ]
		{	if (i == 0)	Set01(0.0, 0.0, 1.0, 0.5);  // [-----]  2h
			else		Set01(0.0, 0.5, 1.0, 0.5);  // [     ]
		}else
		{   if (i == 0) Set01(0.0, 0.0, 0.5, 1.0);  // [  |  ]
			else		Set01(0.5, 0.0, 0.5, 1.0);  // [  |  ]  2v
		}	break;                                  // [  |  ]
	case 3:
		if (horizontal)
		{	if (i == 0)       Set01(0.0, 0.0, 0.5, 0.5);  // [   |   ]
			else if (i == 1)  Set01(0.5, 0.0, 0.5, 0.5);  // [-------]  3h
			else if (i == 2)  Set01(0.0, 0.5, 1.0, 0.5);  // [       ]
		}else
		{	if (i == 0)       Set01(0.0, 0.0, 0.5, 1.0);  // [   |   ]
			else if (i == 1)  Set01(0.5, 0.0, 0.5, 0.5);  // [   |---]  3v
			else if (i == 2)  Set01(0.5, 0.5, 0.5, 0.5);  // [   |   ]
		}	break;
	case 4:                                         // [   |   ]
		Set01((i%2) * 0.5, (i/2) * 0.5, 0.5, 0.5);  // [---+---]  4
		break;                                      // [   |   ]
	case 5:
		if (horizontal)
		{	if (i < 3)        Set01(i * t, 0.0, t, 0.5);  // [  |   |  ]
			else if (i == 3)  Set01(0.0, 0.5, 0.5, 0.5);  // [---------]  5h
			else if (i == 4)  Set01(0.5, 0.5, 0.5, 0.5);  // [    |    ]
		}else{
			if (i < 3)        Set01(0.0, i*t, 0.5, t);    // [__|  ]
			else if (i == 3)  Set01(0.5, 0.0, 0.5, 0.5);  // [__|--]  5v
			else if (i == 4)  Set01(0.5, 0.5, 0.5, 0.5);  // [  |  ]
		}	break;
	case 6:                                      // [  |  |  ]
		Set01((i%3) * t, (i/3) * 0.5, t, 0.5);   // [--+--+--]  6
		break;                                   // [  |  |  ]
	}
	Upd1();    
}
